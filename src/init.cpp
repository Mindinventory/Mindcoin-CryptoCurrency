    ...
    try
    {
        ...
        if (mapArgs.count("-?") || mapArgs.count("--help"))
        {
            ...
            std::string strUsage = _("Mindcoin version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  mindcoind [options]                     " + "\n" +
                  "  mindcoind [options] <command> [params]  " + _("Send command to -server or mindcoind") + "\n" +
                  "  mindcoind [options] help                " + _("List commands") + "\n" +
                  "  mindcoind [options] help <command>      " + _("Get help for a command") + "\n";
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -pid=<file>            " + _("Specify pid file (default: mindcoind.pid)") + "\n" +
